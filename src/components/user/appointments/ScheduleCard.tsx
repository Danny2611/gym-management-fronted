          ...
          {schedule.type === "appointment" ? (
            ...
            <div className="mr-4 h-12 w-12 overflow-hidden rounded-full">
              {schedule.trainer_image ? (
                <Avatar
                  src={`http://localhost:5000/public/${schedule.trainer_image}`}
                  alt="PT"
                  size="xlarge"
...
//               {schedule.type === "workout" && schedule.duration ? (
//                   <span className="text-sm text-gray-600 dark:text-gray-300">
//                     {schedule.timeStart ? formatFullDate(schedule.timeStart) : null}
...
//         {schedule.status === "upcoming"  && schedule.type === "appointment"  && (
//           <Button
//             size="small"
//             variant="outline"
